...
<div class="card">
    <div class="card-header" style="padding:10px ">
        Buat Data Rencana Anggaran Biaya
    </div>

    <div style="background-color: #ebedf0" class="card-body">
    <form style="padding:20px " action="{{ route("admin.buku_rencanaA.store") }}" method="POST" enctype="multipart/form-data">
            @csrf
            
            <div class="row">
                <div class="form-group col-md-3 {{ $errors->has('tahun_anggaran') ? 'has-error' : '' }}">
                    <label for="">Tahun Anggaran*</label>
                    <input type="text" id="tahun_anggaran" name="tahun_anggaran" class="form-control" value="{{ old('tahun_anggaran', isset($buku_rencanaA) ? $buku_rencanaA->tahun_anggaran : '') }}">
            ...
            <div class="row">
                <div class="form-group col-md-3 {{ $errors->has('bidang') ? 'has-error' : '' }}">
                    ...
                    value="{{ old('bidang', isset($buku_rencanaA) ? $buku_rencanaA->bidang : '') }}">
            ...
            <div class="row">
                <div class="form-group col-md-3 {{ $errors->has('kegiatan') ? 'has-error' : '' }}">
                    ...
                    value="{{ old('kegiatan', isset($buku_rencanaA) ? $buku_rencanaA->kegiatan : '') }}">
            ...
            <div class="row">
                <div class="form-group col-md-3 {{ $errors->has('waktu_pelaksanaan') ? 'has-error' : '' }}">
                    ...
                    value="{{ old('waktu_pelaksanaan', isset($buku_rencanaA) ? $buku_rencanaA->waktu_pelaksanaan : '') }}">
            ...
            <div class="row">
                <div class="form-group col-md-6 {{ $errors->has('uraian') ? 'has-error' : '' }}">
                    ...
                    value="{{ old('uraian', isset($buku_rencanaA) ? $buku_rencanaA->uraian : '') }}">
            ...
            <div class="row">
                <div class="form-group col-md-3 {{ $errors->has('volume') ? 'has-error' : '' }}">
                    ...
                    value="{{ old('volume', isset($buku_rencanaA) 
            ...
            <div class="row">
                <div class="form-group col-md-3 {{ $errors->has('harga_satuan') ? 'has-error' : '' }}">
                    ...
                    value="{{ old('harga_satuan', isset($buku_rencanaA) 
                        ? $buku_rencanaA->harga_satuan : '') }}">
