...
<div class="card">
    ...
    <div class="card-body">
        <form style="padding:20px " action="{{ route("admin.buku_kas_prpl.update", [$buku_kas_prpl->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
            ...
            <div class="row">
                <div class="form-group col-md-3 {{ $errors->has('pemotongan') ? 'has-error' : '' }}">
                    ...
                    value="{{  $buku_kas_prpl->pemotongan  }}">
            ...
            <div class="row">
                <div class="form-group col-md-3 {{ $errors->has('penyetoran') ? 'has-error' : '' }}">
                    ...
                    value="{{  $buku_kas_prpl->penyetoran  }}">
