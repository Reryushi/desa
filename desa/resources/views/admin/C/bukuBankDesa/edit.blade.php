...
<div class="card">
    ...
    <div class="card-body">
        <form style="padding:20px " action="{{ route("admin.buku_bank.update", [$buku_bank->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
