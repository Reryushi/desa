...
<div class="card">
    ...
    <div class="card-body">
        <form style="padding:20px " action="{{ route("admin.buku_kas_umum.update", [$buku_kas_umum->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
            ...
            <div class="row">
                <div class="form-group col-md-3 {{ $errors->has('kode_rekening') ? 'has-error' : '' }}">
                    ...
                    value="{{  $buku_kas_umum->kode_rekening  }}">
            ...
            <div class="row">
                <div class="form-group col-md-3 {{ $errors->has('penerimaan') ? 'has-error' : '' }}">
                    ...
                    value="{{  $buku_kas_umum->penerimaan  }}">
            ...
            <div class="row">
                <div class="form-group col-md-3 {{ $errors->has('pengeluaran') ? 'has-error' : '' }}">
                    ...
                    value="{{  $buku_kas_umum->pengeluaran }}">
            ...
            <div class="row">
                <div class="form-group col-md-3 {{ $errors->has('pengeluaran_komulatif') ? 'has-error' : '' }}">
                    ...
                    value="{{ $buku_kas_umum->pengeluaran_komulatif  }}">
