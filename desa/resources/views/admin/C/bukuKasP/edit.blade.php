...
<div class="card">
    ...
    <div style="background-color: #ebedf0" class="card-body">
        <form style="padding:20px " action="{{ route("admin.buku_kasP.update", [$buku_kasP->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="form-group col-md-3 {{ $errors->has('tanggal') ? 'has-error' : '' }}">
                    ...
                    class="form-control" value="{{ $buku_kasP->tanggal  }}">
            ...
            <div class="row">
                <div class="form-group col-md-6 {{ $errors->has('uraian') ? 'has-error' : '' }}">
                    ...
                    class="form-control" value="{{  $buku_kasP->uraian }}">
            ...
            <div class="row">
                <div class="form-group col-md-3 {{ $errors->has('dari_bendahara') ? 'has-error' : '' }}">
                    ...
                    class="form-control" value="{{  $buku_kasP->dari_bendahara }}">
                ...
                <div class="form-group col-md-3 {{ $errors->has('swadaya_masyarakat') ? 'has-error' : '' }}">
                    ...
                    class="form-control" value="{{  $buku_kasP->swadaya_masyarakat  }}">
            ...
            <div class="row">
                <div class="form-group col-md-3 {{ $errors->has('nomor_bukti') ? 'has-error' : '' }}">
                    ...
                    class="form-control" value="{{  $buku_kasP->nomor_bukti  }}">
            ...
            <div class="row">
                <div class="form-group col-md-3 {{ $errors->has('beli_barang_jasa') ? 'has-error' : '' }}">
                    ...
                    class="form-control" value="{{  $buku_kasP->beli_barang_jasa }}">
                ...
                <div class="form-group col-md-3 {{ $errors->has('beli_modal') ? 'has-error' : '' }}">
                    ...
                    class="form-control" value="{{ $buku_kasP->beli_modal  }}">
            ...
            <div class="row">
                <div class="form-group col-md-6 {{ $errors->has('pengembalian_ke_bendahara') ? 'has-error' : '' }}">
                    ...
                    class="form-control" value="{{ $buku_kasP->pengembalian_ke_bendahara  }}">
            ...
            <div class="row">
                <div class="form-group col-md-3 {{ $errors->has('saldo_kas') ? 'has-error' : '' }}">
                    ...
                    class="form-control" value="{{  $buku_kasP->saldo_kas  }}">
