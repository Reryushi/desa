...
<div class="card">
    <div class="card-header" style="padding:10px ">
        Edit Inventaris Kekayaan
    </div>

    <div class="card-body">
        <form action="{{ route("admin.inventariskekayaan.update", [$inventariskekayaan->id]) }}" method="POST" enctype="multipart/form-data" style="padding:20px">
            @csrf
            @method('PUT')
            <div class="row">
