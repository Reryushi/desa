...
<div class="card">
    <div class="card-header" style="padding:10px ">
        Edit Data KTP dan KK
    </div>

    <div class="card-body">
        <form style="padding:20px " action="{{ route("admin.buku_ktp.update", [$buku_ktp->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="form-group col-md-3 {{ $errors->has('no_kk') ? 'has-error' : '' }}">
                    <label for="nomor_kk">Nomor KK*</label>
                    <input type="number" id="no_kk" name="no_kk" class="form-control" value="{{  $buku_ktp->no_kk  }}">
                    @if($errors->has('no_kk'))
                        <p class="help-block">
                            {{ $errors->first('no_kk') }}
                        </p>
            ...
            <div class="row">
                <div class="form-group col-md-6 {{ $errors->has('nama_lengkap') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="nama_lengkap" name="nama_lengkap" class="form-control" value="{{  $buku_ktp->nama_lengkap }}">
            ...
            <div class="row">
                <div class="form-group col-md-3 {{ $errors->has('nik') ? 'has-error' : '' }}">
                    ...
                    <input type="number" id="nik" name="nik" class="form-control" value="{{  $buku_ktp->nik  }}">
                    @if($errors->has('nik'))
                        <p class="help-block">
                            {{ $errors->first('nik') }}
                        </p>
                ...
                <div class="form-group col-md-3 {{ $errors->has('jenis_kelamin') ? 'has-error' : '' }}">
                    <label for="jenis_kelamin">Jenis Kelamin*</label>
                        <select name="jenis_kelamin" id="jenis_kelamin" class="form-control">
                            <option value="{{$buku_ktp->jenis_kelamin}}">
                            {{$buku_ktp->jenis_kelamin}}
                            </option>
                            <option value="L">
                                    Laki-Laki
                            </option>
            ...
            <div class="row">
                <div class="form-group col-md-3 {{ $errors->has('tempat_lahir') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="tempat_lahir" name="tempat_lahir" class="form-control" value="{{  $buku_ktp->tempat_lahir  }}">
                ...
                <div class="form-group col-md-3 {{ $errors->has('tanggal_lahir') ? 'has-error' : '' }}">
                    ...
                    <input type="date" id="tanggal_lahir" name="tanggal_lahir" class="form-control" value="{{  $buku_ktp->tanggal_lahir  }}">
                ...
                <div class="form-group col-md-3 {{ $errors->has('gol_darah') ? 'has-error' : '' }}">
                    <label for="gol_darah">Golongan Darah*</label>
                        <select name="gol_darah" id="gol_darah" class="form-control">
                            <option value="{{$buku_ktp->gol_darah}}">
                            {{$buku_ktp->gol_darah}}
                            </option>
                            <option value="A">
                                    A
                ...
                <div class="form-group col-md-3 {{ $errors->has('pendidikan') ? 'has-error' : '' }}">
                    <label for="pendidikan">Pendidikan Terakhir*</label>
                        <select name="pendidikan" id="pendidikan" class="form-control">
                            <option value="{{$buku_ktp->pendidikan}}">
                            {{$buku_ktp->pendidikan}}
                            </option>
            ...
            <div class="row">
                <div class="form-group col-md-6 {{ $errors->has('pekerjaan') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="pekerjaan" name="pekerjaan" class="form-control" value="{{  $buku_ktp->pekerjaan }}">
            ...
            <div class="row">
                <div class="form-group col-md-6 {{ $errors->has('alamat') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="alamat" name="alamat" class="form-control" value="{{ $buku_ktp->alamat  }}">
                ...
                <div class="form-group col-md-3 {{ $errors->has('status_perkawinan') ? 'has-error' : '' }}">
                    <label for="status_perkawinan">Status Perkawinan*</label>
                        <select name="status_perkawinan" id="status_perkawinan" class="form-control">
                            <option value="{{$buku_ktp->status_perkawinan}}">
                            {{$buku_ktp->status_perkawinan}}
                            </option>
            ...
            <div class="row">
                <div class="form-group col-md-3 {{ $errors->has('tempat_ektp_keluar') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="tempat_ektp_keluar" name="tempat_ektp_keluar" class="form-control" value="{{ $buku_ktp->tempat_ektp_keluar  }}">
                ...
                <div class="form-group col-md-3 {{ $errors->has('tanggal_ektp_keluar') ? 'has-error' : '' }}">
                    ...
                    <input type="date" id="tanggal_ektp_keluar" name="tanggal_ektp_keluar" class="form-control" value="{{ $buku_ktp->tanggal_ektp_kelua  }}">
                ...
                <div class="form-group col-md-3 {{ $errors->has('status_hub_keluarga') ? 'has-error' : '' }}">
                    <label for="status_hub_keluarga">Status hubungan dalam keluarga*</label>
                        <select name="status_hub_keluarga" id="status_hub_keluarga" class="form-control">
                            <option value="{{$buku_ktp->status_hub_keluarga}}">
                            {{$buku_ktp->status_hub_keluarga}}
                            </option>
            ...
            <div class="row">
                <div class="form-group col-md-3 {{ $errors->has('nama_ayah') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="nama_ayah" name="nama_ayah" class="form-control" value="{{  $buku_ktp->nama_ayah  }}">
                ...
                <div class="form-group col-md-3 {{ $errors->has('nama_ibu') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="nama_ibu" name="nama_ibu" class="form-control" value="{{  $buku_ktp->nama_ibu  }}">
            ...
            <div class="row">           
                <div class="form-group col-md-3 {{ $errors->has('tgl_tinggal_didesa') ? 'has-error' : '' }}">
                    ...
                    <input type="date" id="tgl_tinggal_didesa" name="tgl_tinggal_didesa" class="form-control" value="{{  $buku_ktp->tgl_tinggal_didesa  }}">
            ...
            <div class="row">
                <div class="form-group col-md-6 {{ $errors->has('ket') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="ket" name="ket" class="form-control" value="{{ $buku_ktp->ket }}">
                    @if($errors->has('ket'))
                        <p class="help-block">
                            {{ $errors->first('ket') }}
                        </p>
