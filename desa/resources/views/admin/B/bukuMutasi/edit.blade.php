...
<div class="card">
    ...
    <div class="card-body">
        <form style="padding:20px " action="{{ route("admin.buku_mutasi.update", [$buku_mutasi->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="form-group col-md-6 {{ $errors->has('nama_lengkap') ? 'has-error' : '' }}">
                    <label for="nama_lengkap">Nama Lengkap*</label>
                    <input type="text" id="nama_lengkap" name="nama_lengkap" class="form-control" value="{{ $buku_mutasi->nama_lengkap }}">
            ...
            <div class="row">
                <div class="form-group col-md-3 {{ $errors->has('tempat_lahir') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="tempat_lahir" name="tempat_lahir" class="form-control" value="{{  $buku_mutasi->tempat_lahir  }}">
                ...
                <div class="form-group col-md-3 {{ $errors->has('tanggal_lahir') ? 'has-error' : '' }}">
                    ...
                    <input type="date" id="tanggal_lahir" name="tanggal_lahir" class="form-control" value="{{ $buku_mutasi->tanggal_lahir }}">
                ...
                <div class="form-group col-md-3 {{ $errors->has('jenis_kelamin') ? 'has-error' : '' }}">
                    <label for="jenis_kelamin">Jenis Kelamin*</label>
                        <select name="jenis_kelamin" id="jenis_kelamin" class="form-control">
                            <option value="{{$buku_mutasi->jenis_kelamin}}">
                                    {{$buku_mutasi->jenis_kelamin}}
                            </option>
                            <option value="L">
                                    Laki-Laki
                            </option>
            ...
            <div class="row">
                <div class="form-group col-md-3 {{ $errors->has('datang_dari') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="datang_dari" name="datang_dari" class="form-control" value="{{  $buku_mutasi->datang_dari  }}">
                ...
                <div class="form-group col-md-3 {{ $errors->has('tanggal_datang') ? 'has-error' : '' }}">
                    ...
                    <input type="date" id="tanggal_datang" name="tanggal_datang" class="form-control" value="{{ $buku_mutasi->tanggal_datang  }}">
            ...
            <div class="row">
                <div class="form-group col-md-3 {{ $errors->has('pindah_ke') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="pindah_ke" name="pindah_ke" class="form-control" value="{{   $buku_mutasi->pindah_ke }}">
                ...
                <div class="form-group col-md-3 {{ $errors->has('tanggal_pindah') ? 'has-error' : '' }}">
                    ...
                    <input type="date" id="tanggal_pindah" name="tanggal_pindah" class="form-control" value="{{ $buku_mutasi->tanggal_pindah  }}">
            ...
            <div class="row">
                <div class="form-group col-md-3 {{ $errors->has('meninggal') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="meninggal" name="meninggal" class="form-control" value="{{ $buku_mutasi->meninggal  }}">
                ...
                <div class="form-group col-md-3 {{ $errors->has('tanggal_meninggal') ? 'has-error' : '' }}">
                    ...
                    <input type="date" id="tanggal_meninggal" name="tanggal_meninggal" class="form-control" value="{{  $buku_mutasi->tanggal_meninggal }}">
            ...
            <div class="row">
                <div class="form-group col-md-6 {{ $errors->has('ket') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="ket" name="ket" class="form-control" value="{{  $buku_mutasi->ket }}">
                    @if($errors->has('ket'))
                        <p class="help-block">
                            {{ $errors->first('ket') }}
                        </p>
