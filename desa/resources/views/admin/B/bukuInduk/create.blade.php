...
<div class="card">
    ...
    <form action="{{ route("admin.buku_induk.store") }}" method="POST" enctype="multipart/form-data" style="padding:20px ">
            @csrf
            <div class="row">
                <div class="form-group col-md-6 {{ $errors->has('nama_lengkap') ? 'has-error' : '' }}">
                    <label for="nama_lengkap">Nama Lengkap*</label>
                    <input type="text" id="nama_lengkap" name="nama_lengkap" class="form-control" value="{{ old('nama_lengkap', isset($induk) ? $induk->nama_lengkap : '') }}">
            ...
            <div class="row">
                <div class="form-group col-md-3 {{ $errors->has('tempat_lahir') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="tempat_lahir" name="tempat_lahir" class="form-control" value="{{ old('tempat_lahir', isset($induk) ? $induk->tempat_lahir : '') }}">
                ...
                <div class="form-group col-md-3 {{ $errors->has('tanggal_lahir') ? 'has-error' : '' }}">
                    ...
                    <input type="date" id="tanggal_lahir" name="tanggal_lahir" class="form-control" value="{{ old('tanggal_lahir', isset($induk) ? $induk->tanggal_lahir : '') }}">
            ...
            <div class="row">
                <div class="form-group col-md-6 {{ $errors->has('pekerjaan') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="pekerjaan" name="pekerjaan" class="form-control" value="{{ old('pekerjaan', isset($induk) ? $induk->pekerjaan : '') }}">
            ...
            <div class="row">
                <div class="form-group col-md-6 {{ $errors->has('alamat') ? 'has-error' : '' }}">
                    ...
                    <input type="text" id="alamat" name="alamat" class="form-control" value="{{ old('alamat', isset($induk) ? $induk->alamat : '') }}">
            ...
            <div class="row">
                <div class="form-group col-md-3 {{ $errors->has('nik') ? 'has-error' : '' }}">
                    ...
                    <input type="number" id="nik" name="nik" class="form-control" value="{{ old('nik', isset($induk) ? $induk->nik : '') }}">
                    @if($errors->has('nik'))
                        <p class="help-block">
                            {{ $errors->first('nik') }}
                        </p>
            ...
            <div class="row">
                <div class="form-group col-md-3 {{ $errors->has('nomor_kk') ? 'has-error' : '' }}">
                    ...
                    <input type="number" id="nomor_kk" name="nomor_kk" class="form-control" value="{{ old('nomor_kk', isset($induk) ? $induk->nomor_kk : '') }}">
