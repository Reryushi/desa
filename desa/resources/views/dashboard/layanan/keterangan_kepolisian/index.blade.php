            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="content">
                            <div class="toolbar">
                                <a href="{{ route("dashboard.surat_ket_catatan_kepolisian.create") }}" rel="tooltip" title="Tambah Surat Keterangan"
                                    ...
                                    @foreach($ket_kepolisian as $key => $ket_kepolisian)
                                        <tr data-entry-id="{{ $ket_kepolisian->id }}">
                                            ...
                                            <td>
                                                    ...
                                                    <a class="btn btn-xs btn-info" href="{{ route('dashboard.surat_ket_catatan_kepolisian.show', $ket_kepolisian->id) }}">
                                                        {{ trans('Download') }}
                                                    </a>
