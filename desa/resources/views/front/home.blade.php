...
<br><br><br><br><br>
    ...
    <div class="">
        <div class="slider fullscreen " style="background-color:rgba(82, 82, 66, 0.14);">
            <ul class="slides">
                @forelse($slider_images as $image)
                <li> <img src="{{ ('front/images/slider/'.$image->name) }}" 
                              alt="">
                    <!-- random image -->
                    <div class="caption  slid-cap" 
                        ...
                        <h3 class="" style="color: #e8c57a; text-shadow:
                         ...
                         -1px -1px 0 #000,  
                          1px -1px 0 #000,
                          -1px 1px 0 #000,
                           1px 1px 0 #000; opacity:0.9">{{ $image->small_title }}</h3>
                    ...
                    @empty
                    <li> <img src="{{ asset("front/images/bg.jpg") }}" alt="">
                    <!-- random image -->
        ...
        <div class="container">
            <!-- <div class="row">
                <div class="hom1-title">
                    ...
                    <p>Produk yang dihasilkan Gunung Katun Tanjungan.</p>
                </div>
            </div> -->
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="hom1-title">
                    ...
                    <p>Beranda Berita Desa Terbaru.</p>
                </div>
            </div>
            <div class="row">
                <div>
...
<!--event IMAGE-->
                        <div class="n21-event hovereffect"> <img src="{{ ('front/images/event/'.$event->image)}}" alt="">
                            <div class="overlay"> <a href="{{ url('/event/') }}"><span class="ev-book">View</span></a> </div>
                        </div>
<!--event DETAILS-->
                        <div class="n22-event"> <a href="{{ url('/event/') }}">
                        <h4>{{ $event->name }}</h4></a> 
                        <!-- <span class="event-date">Date: {{ $event->date }},</span> <span class="event-by"> Price: {{ $event->price > 0? config('app.currency').$event->price : 'Free'}}</span> -->
                ...
                <div class="col-md-12">
                    <div class="inn-services head-typo typo-com mar-bot-0">
                        <ul id="filters" class="clearfix">
                            ...
                            <li><span class="filter" data-filter=".room">Kegiatan</span>
                            </li>
                            <li><span class="filter" data-filter=".food">Lainnya</span>
                            </li>
                            <li><span class="filter" data-filter=".event">Berita</span>
                            </li>
                        </ul>
