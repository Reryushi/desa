@section('footer')
    <footer class="site-footer clearfix">
                ...
                <div class="widget-area clearfix">
                    <div class="widget widget_azh_widget">
                        <div>
                            <div class="container">
                                <div class="row">
                                    <div class="col-sm-12 col-md-3 foot-logo"> <img src="{{ asset("front/images/logo/tiyuh.png") }}" height="80px" alt="logo">
                                        <p class="hasimg">Desa Gunung Katun Tanjungan</p>
                                        <p class="hasimg">Tulang Bawang Barat.</p>
                                    </div>
        ...
        <div class="copyright" style="text-align:center;font-size:12px">
            &copy; <script>document.write(new Date().getFullYear())</script>, developed by A.S, A.M, R.K.M
        </div>
        <!-- #quaternary -->
    </footer>
