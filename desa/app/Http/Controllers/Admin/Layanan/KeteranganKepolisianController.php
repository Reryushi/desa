...
class KeteranganKepolisianController extends AdminController
{
    ...
    {
        $ket_kepolisian = KeteranganKepolisian::all();

        return view('layanan/keterangan_kepolisian/index', compact('ket_kepolisian'));
    ...
    {
        return view('layanan/keterangan_kepolisian/template_surat');
    }
    ...
    public function store(Request $request)
    {
        ...
        $array = array(
            ...
            '[form_keterangan]' => $form_keterangan,
            '[no_ktp]' => $penduduk->no_ktp,
            '[no_kk]' => $penduduk->no_kk,
            '[tgl_surat]' => $tgl_surat,
        ...
        return redirect('admin/surat_ket_catatan_kepolisian');
    }
