...
class KeteranganPendudukController extends AdminController
{
    ...
    {
        $ket_penduduk = KeteranganPenduduk::where('penduduk_id', Auth::user()->id)->get();

        return view('dashboard.layanan.keterangan_penduduk.index', compact('ket_penduduk'));
    ...
    {
        return view('dashboard.layanan.keterangan_penduduk.template_surat');
    }
    ...
    public function store(Request $request)
    {
        ...
        $id_surat = KeteranganPenduduk::orderBy('id', 'desc')->first()->id;
        $jumlah = $id_surat + 1;

        $surat_template = new KeteranganPenduduk();
        $surat_template->id = $request->input('id');
        $judul=
        $surat_template->judul = 'Surat Keterangan Penduduk';
        $nomor_surat=
        ...
        return redirect()->route('dashboard.surat_ket_penduduk.index');
    ...
    public function show($id)
    {
        ...
        return redirect('dashboard/layanan/surat_ket_penduduk');
    }
